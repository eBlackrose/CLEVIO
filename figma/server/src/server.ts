...
// PUT Company
app.put('/api/company', authenticate, async (req: AuthRequest, res) => {
...
// PUT Notifications
app.put('/api/notifications', authenticate, async (req: AuthRequest, res) => {
...
// POST Team Member
app.post('/api/team', authenticate, async (req: AuthRequest, res) => {
...
// GET AMEX Card
app.get('/api/payments/amex', authenticate, async (req: AuthRequest, res) => {
  try {
...
// GET Advisory Sessions
app.get('/api/advisory', authenticate, async (req: AuthRequest, res) => {
  try {
